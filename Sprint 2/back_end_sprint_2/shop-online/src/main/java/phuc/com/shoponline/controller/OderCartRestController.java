...
public ResponseEntity<?> getProductInCard(@RequestBody Customer customer) {
    ...
    public ResponseEntity<?> minusQuantityCart(@RequestBody Oder productOrder) {
        List<Oder> productOrderList = this.iOderCartService.getProductInCardByCustomer(productOrder.getCustomer());
        Boolean check = this.iOderCartService.minusQuantity(productOrder);
        if (check) {
    ...
    public ResponseEntity<?> plusQuantityCart(@RequestBody Oder productOrder) {
        List<Oder> productOrderList = this.iOderCartService.getProductInCardByCustomer(productOrder.getCustomer());
        Boolean check = this.iOderCartService.plusQuantity(productOrder);
        if (check) {
            return new ResponseEntity<>(productOrderList, HttpStatus.OK);
        }
        ErrorDto errorDto = new ErrorDto();
    ...
    public ResponseEntity<?> deleteProductInCart(@RequestBody Oder productOrder) {
        Boolean check = this.iOderCartService.findProductOrder(productOrder);
        if (check) {
            List<Oder> productOrderList = this.iOderCartService.getProductInCardByCustomer(productOrder.getCustomer());
            return new ResponseEntity<>(productOrderList, HttpStatus.OK);
        }
    ...
    public ResponseEntity<?> goPayment(@RequestBody Customer customer) throws MessagingException {
        PaymentDto paymentDto = this.iOderCartService.goPayment(customer);

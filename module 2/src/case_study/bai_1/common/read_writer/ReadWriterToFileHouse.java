...
public class ReadWriterToFileHouse {
    ...
    public void writerToFileHouse(List<House> houseList) {
        try {
            FileWriter fileWriter = new FileWriter("case_study/bai_1/common/data/house.csv");
    ...
    public List<House> readToFileHouse() {
        ...
        try {
            FileReader fileReader = new FileReader("case_study/bai_1/common/data/house.csv");

...
--                     cho tất cả các khách hàng đã từng đặt phòng. 
 ...
 -- taks7.	Hiển thị thông tin ma_dich_vu, ten_dich_vu, dien_tich, 
...
-- tack 10 10.	Hiển thị thông tin tương ứng với từng hợp đồng thì đã sử dụng
...
group by hop_dong.ma_hop_dong;
          ...
          -- tack 11.  	Hiển thị thông tin các dịch vụ đi kèm đã được sử dụng bởi những khách hàng có ten_loai_khach là 
...
having so_lan_su_dung_nhieu_nhat = (select max(hop_dong_chi_tiet.so_luong) from hop_dong_chi_tiet);
 ...
 -- tack14.	Hiển thị thông tin tất cả các Dịch vụ đi kèm chỉ mới được sử dụng một lần duy nhất. 
